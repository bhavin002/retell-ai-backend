...
beginSentence = "You can ask me anything, and I'll provide an answer related to your question."
agentPrompt = "Task: You are developing a conversational AI that echoes the user's questions. Your task is to provide an answer related to the user's question. Ensure that the response is relevant and informative."
        ...
        functions= [
            {
                ...
                "function": {
                    "name": "end_call",
                    "description": "End the call only when user say bye.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "message": {
    ...
    def draft_response(self, request):      
        ...
        for chunk in stream:
            ...
            if chunk.choices[0].delta.content:
                content = chunk.choices[0].delta.content.lower()
                if "bye" in content:
                    bye_detected = True
                else:
                    yield {
        ...
        if bye_detected:
            print("User said bye. Ending the call.")
            yield {
                "response_id": request['response_id'],
                "content": "Goodbye!",
                "content_complete": True,
